...
export function SoftDecorShapes({ variant = "dashboard", className }: SoftDecorShapesProps) {
  ...
  return (
    <div className={cn("pointer-events-none absolute inset-0 overflow-hidden", className)} aria-hidden="true">
      ...
      <div
        className={cn(
          "absolute rotate-12 rounded-[28px] bg-linear-to-br from-[#c5cdfc]/85 to-[#b3c0f8]/80 shadow-[0_24px_60px_-36px_rgba(117,126,206,0.95)] animate-float-soft",
      ...
      <div
        className={cn(
          "absolute rounded-[30%_70%_68%_32%/28%_40%_60%_72%] bg-linear-to-br from-[#dbe1ff]/90 to-[#c0caf6]/90 shadow-[0_24px_56px_-34px_rgba(118,128,210,0.9)] animate-float-soft",
      ...
      <div
        className={cn(
          "absolute h-0 w-0 border-l-[36px] border-r-[36px] border-b-[58px] border-l-transparent border-r-transparent border-b-[#c8c3f1]/65 drop-shadow-[0_14px_18px_rgba(132,140,214,0.25)] animate-float-soft",
